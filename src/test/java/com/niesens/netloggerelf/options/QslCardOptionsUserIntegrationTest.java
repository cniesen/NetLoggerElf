...
@SpringBootTest(properties = {
        "qslCard.pdfName=qsl-cards-ccyy-mm-dd-hh-mm-ss.pdf",
        "qslCard.text.fontFile=text.tiff",
        "qslCard.callsign.fontFile=callsign.tiff",
        "qslCard.callsign.bold=true"
})
class QslCardOptionsUserIntegrationTest {
    ...
    @Test
    void getPdfName() {
        assertThat(options.getQslCard().getPdfName()).isEqualTo("qsl-cards-ccyy-mm-dd-hh-mm-ss.pdf");
    }

    @Test
    void getText_getFont() {
        assertThat(options.getQslCard().getText().getFontFile()).isEqualTo("text.tiff");
    }
    ...
    void getCallsign_getFont() {
        assertThat(options.getQslCard().getCallsign().getFontFile()).isEqualTo("callsign.tiff");
    }
    ...
    void getCallsign_getBold() {
        assertThat(options.getQslCard().getCallsign().getBold()).isTrue();
    }
